...
# Focus: file-backed credentials with RFC3339 expiration skip refresh.
...
my $creds_file = "/tmp/nginx-s3gw-creds-049-$$.json";
open my $fh, '>', $creds_file or die "open $creds_file: $!";
print {$fh} '{"accessKeyId":"A","secretAccessKey":"B","sessionToken":"C","expiration":"2100-01-01T00:00:00Z"}';
close $fh;
...
like($resp, qr/^HTTP\/1\.1 200 /m,
    'future RFC3339 file credentials short-circuit refresh with 200');
like($resp, qr/\r\nContent-Length: 0\r\n/i,
