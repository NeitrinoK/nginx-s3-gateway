...
# Focus: GET and HEAD parent requests can route to different branches in loadContent flow.
...
like($get_resp, qr/^HTTP\/1\.1 200 /m,
    'GET parent request resolves index and returns 200');
like($head_resp, qr/^HTTP\/1\.1 209 /m,
    'HEAD parent request follows fallback branch in this fixture');
unlike($head_resp, qr/^HTTP\/1\.1 404 /m,
    'HEAD response is not an index-object 404 in this flow');
