...
# Focus: valid keyval credentials with far-future expiration should skip refresh.
...
http {
    ...
    server {
        ...
        location /fetch {
            ...
            set $instance_credential_json '{"accessKeyId":"A","secretAccessKey":"B","sessionToken":"C","expiration":"4102444800"}';
...
like($resp, qr/^HTTP\/1\.1 200 /m,
    'fetchCredentials returns 200 when cached keyval credentials are still valid');
like($resp, qr/\r\nContent-Length: 0\r\n/i,
