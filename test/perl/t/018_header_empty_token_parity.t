...
# Focus: in njs, an empty token in HEADER_PREFIXES_ALLOWED (for example via ";;")
...
like($resp, qr/\r\nX-Amz-Request-Id: amz-123\r\n/i,
    'x-amz-* remains present with explicit allow prefix');
like($resp, qr/\r\nX-Custom-Secret: hidden\r\n/i,
    'empty allow token from ";;" behaves like wildcard as in njs');
