...
# Focus: expired keyval credentials trigger refresh path; controlled refresh failure
# (invalid web-identity token file) returns 500.
...
like($resp, qr/^HTTP\/1\.1 500 /m,
    'fetchCredentials returns 500 when refresh path fails');
like($resp, qr/\r\nContent-Length: 0\r\n/i,
