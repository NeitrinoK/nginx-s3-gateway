...
# Focus: credential scope must use configured S3_REGION and S3_SERVICE.
...
like($resp, qr/Credential=AKIDEXAMPLE\/\d{8}\/eu-central-1\/s3-outposts\/aws4_request/i,
    'credential scope uses configured region and service');
like($resp, qr/Signature=[0-9a-f]{64}\r\n/i,
    'signature field has expected lowercase hex shape');
