...
# Focus: when PROVIDE_INDEX_PAGE=false, loadContent must route straight to @s3Directory.
...
like($resp, qr/^HTTP\/1\.1 209 /m,
    'loadContent without index mode routes to @s3Directory');
like($resp, qr/\r\n\r\ndirectory$/s,
    'directory fallback body is returned');
