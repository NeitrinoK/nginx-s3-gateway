...
# in path style (query-based listing vs object-style root path).
...
like($get_resp, qr/\r\nX-S3URI: \/bucket-1\?delimiter=%2F\r\n/i,
    'GET /root uses delimiter query for directory listing');
like($head_resp, qr/\r\nX-S3URI: \/bucket-1\/\r\n/i,
    'HEAD /root uses object-style root path');
...
isnt($get_auth, $head_auth,
     'GET and HEAD root requests produce different SigV4 signatures');
