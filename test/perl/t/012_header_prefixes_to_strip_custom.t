...
# Header filter tests for ngx_http_s3_gateway_c_module.
# Focus: custom HEADER_PREFIXES_TO_STRIP handling.
...
like($resp, qr/\r\nX-Keep: yes\r\n/i, 'non-target header is preserved');
unlike($resp, qr/\r\nX-Custom-Secret:/i, 'custom configured prefix header is stripped');
unlike($resp, qr/\r\nX-Amz-Request-Id:/i, 'x-amz-* header is still stripped');
