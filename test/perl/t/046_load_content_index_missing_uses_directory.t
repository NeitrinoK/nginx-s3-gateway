...
# Focus: index probe returns 404 -> loadContent falls back to @s3Directory.
...
like($resp, qr/^HTTP\/1\.1 209 /m,
    '404 from index probe routes to @s3Directory');
like($resp, qr/\r\n\r\ndirectory-fallback$/s,
    'directory fallback location handles final response');
