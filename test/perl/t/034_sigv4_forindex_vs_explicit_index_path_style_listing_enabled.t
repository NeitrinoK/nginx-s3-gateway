...
# Focus: with ALLOW_DIRECTORY_LIST=true and PROVIDE_INDEX_PAGE=false,
# forIndexPage=true suppresses listing query but canonical URI remains directory path.
...
like($dir, qr/\r\nX-S3URI: \/bucket-1\/docs\/\r\n/i,
    'forIndexPage=true uses directory object URI when PROVIDE_INDEX_PAGE=false');
like($idx, qr/\r\nX-S3URI: \/bucket-1\/docs\/index\.html\r\n/i,
    'explicit index keeps index.html object URI');
...
isnt($dir_auth, $idx_auth,
     'directory canonical URI and explicit index canonical URI produce different signatures');
unlike($dir, qr/\?delimiter=%2F&prefix=/i,
       'forIndexPage=true suppresses listing query generation for signature path');
